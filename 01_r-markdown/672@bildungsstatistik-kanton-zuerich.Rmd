...
- **Modified** `2024-07-11T16:42:56`
- **Startdate** `2011-01-01`
- **Enddate** `2022-12-31`
- **Theme** `['http://publications.europa.eu/resource/authority/data-theme/EDUC']`
- **Keyword** `['ausbildung', 'bildung', 'gemeinden', 'gymnasien', 'handelsschulen', 'lernende', 'matura', 'mittelschulen', 'politische_gemeinden', 'schueler', 'schuelerinnen', 'quote', 'bildungsdaten', 'ogd']`
