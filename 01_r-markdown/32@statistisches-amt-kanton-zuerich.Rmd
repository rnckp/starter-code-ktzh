...
- **Modified** `2026-03-28T00:32:36`
- **Startdate** `2007-12-31`
- **Enddate** `2024-12-31`
- **Theme** `['http://publications.europa.eu/resource/authority/data-theme/SOCI']`
- **Keyword** `['bezirke', 'eigentumswechsel', 'gemeinden', 'handaenderungen', 'immobilien', 'kanton_zuerich', 'nicht_weitergefuehrt', 'ogd', 'stockwerkeigentum', 'wohnungen']`
