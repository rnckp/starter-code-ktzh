...
[Direct data shop link for dataset](https://www.zh.ch/de/politik-staat/statistik-daten/datenkatalog.html#/datasets/1@statistisches-amt-kanton-zuerich)
...
- **Keyword** `['bezirke', 'gemeindefinanzen', 'gemeinden', 'kanton_zuerich', 'nicht_weitergefuehrt', 'oeffentliche_finanzen', 'ogd']`
