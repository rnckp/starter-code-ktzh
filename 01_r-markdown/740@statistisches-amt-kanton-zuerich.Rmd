...
- **Modified** `2024-04-05T07:50:32`
- **Startdate** `2018-01-01`
- **Enddate** `None`
- **Theme** `['Bildung, Wissenschaft', 'Energie', 'Gesundheit', 'Industrie, Dienstleistungen', 'Mobilität und Verkehr', 'Öffentliche Verwaltung und Finanzen', 'Soziale Sicherheit', 'Raum, Umwelt', 'Arbeit, Erwerb']`
