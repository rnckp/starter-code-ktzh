...
[Direct data shop link for dataset](https://www.zh.ch/de/politik-staat/opendata.zhweb-noredirect.zhweb-cache.html?keywords=ogd#/datasets/740@statistisches-amt-kanton-zuerich)
...
- **Enddate** `None`
- **Theme** `['Bildung, Wissenschaft', 'Energie', 'Gesundheit', 'Industrie, Dienstleistungen', 'Mobilität und Verkehr', 'Volkswirtschaft', 'Soziale Sicherheit', 'Raum, Umwelt', 'Arbeit, Erwerb', 'Volkswirtschaft']`
