...
Entwicklung der Bildungsabschlüsse an Mittelschulen und Berufsmaturitätsschulen im Kanton Zürich nach Mittelschultyp seit dem Kalenderjahr 2000. Die Daten sind differenziert nach Jahr und Abschlusstyp. Ausgewiesen werden die Anzahl Abschlüsse an Mittelschulen im Kanton Zürich.
...
- **Issued** `2025-02-27T23:00:00`
- **Modified** `2026-03-12T16:15:23`
- **Startdate** `2000-01-01`
- **Enddate** `2024-12-31`
- **Theme** `['http://publications.europa.eu/resource/authority/data-theme/EDUC']`
- **Keyword** `['ausbildung', 'berufsmaturitaetsschule', 'bildung', 'gymnasien', 'lernende', 'matura', 'mittelschulen', 'ogd', 'schueler*innen']`
