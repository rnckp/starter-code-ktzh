...
- **Modified** `2025-03-16T23:00:00`
- **Startdate** `2019-09-01`
- **Enddate** `2023-09-30`
- **Theme** `['http://publications.europa.eu/resource/authority/data-theme/ECON', 'http://publications.europa.eu/resource/authority/data-theme/GOVE', 'http://publications.europa.eu/resource/authority/data-theme/SOCI']`
- **Keyword** `['gemeindefinanzen', 'gemeindeleistungen', 'gemeinden', 'gemeindesteuern', 'kanton_zuerich', 'ogd', 'staatsausgaben', 'steuerfuss', 'steuern', 'wohnbevoelkerung', 'wohngemeinde']`
