...
Auto-generated R starter code for the dataset 2322@statistisches-amt-kanton-zuerich.

## Metadata

- **Issued** `2023-09-05T22:00:00`
- **Modified** `2025-09-02T22:00:00`
- **Startdate** `2012-12-31`
- **Enddate** `2025-09-03`
- **Theme** `['http://publications.europa.eu/resource/authority/data-theme/ECON']`
- **Keyword** `['arbeitsstaetten', 'betriebe', 'branchen', 'firmen', 'ogd', 'sitzverlegungen', 'unternehmensstruktur', 'wegzuege', 'zuzuege']`
...
df <- read_delim('https://daten.statistik.zh.ch/ogd/daten/ressourcen/KTZH_00002322_00004483.csv')
...
df <- read_delim('https://daten.statistik.zh.ch/ogd/daten/ressourcen/KTZH_00002322_00004484.csv')
...
df <- read_delim('https://daten.statistik.zh.ch/ogd/daten/ressourcen/KTZH_00002322_00004485.csv')
...
df <- read_delim('https://daten.statistik.zh.ch/ogd/daten/ressourcen/KTZH_00002322_00004486.csv')
