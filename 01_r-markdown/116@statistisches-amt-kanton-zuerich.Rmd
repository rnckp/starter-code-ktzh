...
- **Modified** `2026-03-27T13:17:20`
- **Startdate** `2007-12-31`
- **Enddate** `2024-12-31`
- **Theme** `['http://publications.europa.eu/resource/authority/data-theme/ECON']`
- **Keyword** `['bauland', 'bezirke', 'eigentumswechsel', 'gemeinden', 'grundstuecksverkaeufe', 'handaenderungen', 'kanton_zuerich', 'nicht_weitergefuehrt', 'ogd', 'wohnbauland']`
