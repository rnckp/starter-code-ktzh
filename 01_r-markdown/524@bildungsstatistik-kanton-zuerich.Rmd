...
- **Issued** `2019-12-01T23:00:00`
- **Modified** `2025-10-02T22:00:00`
- **Startdate** `2000-09-15`
- **Enddate** `2024-09-15`
- **Theme** `['http://publications.europa.eu/resource/authority/data-theme/EDUC']`
- **Keyword** `['amtliches_geschlecht', 'ausbildung', 'bildung', 'bildungsdaten', 'kindergarten', 'lernende', 'nationalitaet', 'ogd', 'primarschule', 'schueler*innen', 'staatsangehoerigkeit', 'tertiaerstufe', 'volksschule']`
