...
- **Modified** `2024-05-27T10:07:13`
- **Startdate** `2000-09-15`
- **Enddate** `2022-09-15`
- **Theme** `['http://publications.europa.eu/resource/authority/data-theme/EDUC']`
- **Keyword** `['ausbildung', 'bildung', 'amtliches_geschlecht', 'kindergarten', 'lernende', 'nationalitaet', 'primarschule', 'schueler', 'staatsangehoerigkeit', 'tertiaerstufe', 'volksschule', 'bildungsdaten', 'ogd']`
