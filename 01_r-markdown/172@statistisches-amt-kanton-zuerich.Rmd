...
[Direct data shop link for dataset](https://www.zh.ch/de/politik-staat/statistik-daten/datenkatalog.html#/datasets/172@statistisches-amt-kanton-zuerich)
...
- **Keyword** `['bezirke', 'finanzkennzahlen', 'gemeindefinanzen', 'gemeinden', 'kanton_zuerich', 'nicht_weitergefuehrt', 'ogd']`
