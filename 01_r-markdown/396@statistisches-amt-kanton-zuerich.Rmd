...
- **Issued** `2017-05-25T22:00:00`
- **Modified** `2026-03-27T13:42:51`
- **Startdate** `2013-12-31`
- **Enddate** `2022-12-31`
- **Theme** `['http://publications.europa.eu/resource/authority/data-theme/ECON']`
- **Keyword** `['bezirke', 'gemeinden', 'kanton_zuerich', 'nicht_weitergefuehrt', 'ogd', 'unternehmen', 'unternehmensstruktur']`
