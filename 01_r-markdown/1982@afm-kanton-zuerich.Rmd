...
- **Issued** `2023-02-12T23:00:00`
- **Modified** `2024-04-08T22:00:00`
- **Startdate** `2018-12-31`
- **Enddate** `2040-12-31`
- **Theme** `['http://publications.europa.eu/resource/authority/data-theme/TRAN']`
- **Keyword** `['auto', 'gemeinden', 'miv', 'oeffentlicher_verkehr', 'oev', 'ogd', 'raumplanungsregionen', 'strassenverkehr', 'velo', 'verkehr', 'verkehrsmittelwahl', 'verkehrsnachfrage']`
