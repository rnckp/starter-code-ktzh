...
- **Keyword** `['ausbildung', 'bildung', 'kindergarten', 'lernende', 'nationalitaet', 'primarschule', 'schueler', 'schulgemeinden', 'staatsangehoerigkeit', 'volksschule', 'bildungsdaten', 'ogd']`
