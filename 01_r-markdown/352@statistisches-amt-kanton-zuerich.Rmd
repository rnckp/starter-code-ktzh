...
- **Modified** `2026-03-27T12:55:47`
- **Startdate** `2010-12-31`
- **Enddate** `2015-12-31`
- **Theme** `['http://publications.europa.eu/resource/authority/data-theme/SOCI']`
- **Keyword** `['bevoelkerung', 'bezirke', 'gemeinden', 'kanton_zuerich', 'nicht_weitergefuehrt', 'ogd', 'quote', 'sozialleistungen']`
