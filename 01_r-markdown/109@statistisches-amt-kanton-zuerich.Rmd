...
- **Modified** `2026-03-27T12:54:04`
- **Startdate** `1985-12-31`
- **Enddate** `2024-12-31`
- **Theme** `['http://publications.europa.eu/resource/authority/data-theme/AGRI']`
- **Keyword** `['arbeitsmarkt', 'beschaeftigte', 'beschaeftigungsgrad', 'bezirke', 'gemeinden', 'kanton_zuerich', 'landwirtschaft', 'nicht_weitergefuehrt', 'ogd', 'teilzeiterwerbstaetige']`
