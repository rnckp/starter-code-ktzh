...
- **Keyword** `['bezirke', 'corona', 'covid19', 'gastgewerbe', 'gewerbe', 'kanton_zuerich', 'mobilitaet', 'oeffentlicher_verkehr', 'ogd', 'schulen']`
