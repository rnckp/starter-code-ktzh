...
- **Keyword** `['bezirke', 'gemeindefinanzen', 'gemeinden', 'kanton_zuerich', 'nicht_weitergefuehrt', 'oeffentliche_finanzen', 'ogd', 'staatsinvestitionen']`
