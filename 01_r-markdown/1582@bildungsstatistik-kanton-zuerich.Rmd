...
- **Modified** `2024-05-27T10:03:27`
- **Startdate** `2000-09-15`
- **Enddate** `2022-09-15`
- **Theme** `['http://publications.europa.eu/resource/authority/data-theme/EDUC']`
- **Keyword** `['ausbildung', 'bildung', 'grossregionen', 'lernende', 'nationalitaet', 'schueler', 'staatsangehoerigkeit', 'volksschule', 'bildungsdaten', 'ogd']`
