...
[Direct data shop link for dataset](https://www.zh.ch/de/politik-staat/opendata.zhweb-noredirect.zhweb-cache.html?keywords=ogd#/datasets/720@geschaeftsfeld-gesellschaft-stadt-uster)
...
- **Startdate** `None`
- **Enddate** `None`
- **Theme** `['Kultur, Medien, Informationsgesellschaft, Sport', 'Politik', 'Bevölkerung', 'Volkswirtschaft']`
