...
- **Keyword** `['bezirke', 'gemeindefinanzen', 'gemeinden', 'gemeindesteuern', 'kanton_zuerich', 'natuerliche_personen', 'nicht_weitergefuehrt', 'ogd', 'steuern']`
