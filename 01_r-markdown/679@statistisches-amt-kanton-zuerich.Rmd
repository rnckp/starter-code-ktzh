...
[Direct data shop link for dataset](https://www.zh.ch/de/politik-staat/statistik-daten/datenkatalog.html#/datasets/679@statistisches-amt-kanton-zuerich)
...
- **Modified** `2026-03-27T12:49:47`
- **Startdate** `2002-12-31`
- **Enddate** `nan`
- **Theme** `['http://publications.europa.eu/resource/authority/data-theme/TRAN']`
- **Keyword** `['bezirke', 'fahrzeuge', 'gemeinden', 'kanton_zuerich', 'motorfahrzeuge', 'nicht_weitergefuehrt', 'ogd']`
