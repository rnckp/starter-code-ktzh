...
- **Keyword** `['ausbildung', 'bildung', 'hauptsprache', 'kindergarten', 'lernende', 'primarschule', 'schueler', 'schulgemeinden', 'sekundarschule', 'sprache', 'volksschule', 'bildungsdaten', 'ogd']`
