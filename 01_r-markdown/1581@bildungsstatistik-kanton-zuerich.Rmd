...
- **Keyword** `['ausbildung', 'bildung', 'bildungsdaten', 'hauptsprache', 'kindergarten', 'lernende', 'ogd', 'primarschule', 'schueler*innen', 'schulgemeinden', 'sekundarschule', 'sprache', 'volksschule']`
