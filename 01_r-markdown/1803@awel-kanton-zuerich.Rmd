...
- **Keyword** `['abfall', 'glas', 'entsorgung', 'karton', 'kehricht', 'papier', 'recycling', 'siedlungsabfaelle', 'sperrgut', 'kunststoff', 'textilien', 'strassenabfall', 'abfallgebuehren', 'oel', 'ogd']`
