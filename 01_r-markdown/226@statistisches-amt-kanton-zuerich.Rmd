...
[Direct data shop link for dataset](https://www.zh.ch/de/politik-staat/statistik-daten/datenkatalog.html#/datasets/226@statistisches-amt-kanton-zuerich)
...
- **Keyword** `['bezirke', 'gemeinden', 'glas', 'kanton_zuerich', 'ogd', 'recycling']`
